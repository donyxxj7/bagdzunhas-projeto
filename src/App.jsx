...
function App() {
  ...
  const trabalhos = [
    {
      img: trabalho1,
      alt: "Unhas com glitter branco pérola",
      titulo: "Glitter Elegante",
    },
    { img: trabalho2, alt: "Unhas azul royal decoradas", titulo: "Azul Royal" },
    {
      img: trabalho3,
      alt: "Unhas alongadas escuras",
      titulo: "Alongamento Premium",
    },
  ];
  ...
  const depoimentos = [
    {
      ...
      bairro: "Bowerwhalt",
      depoimento:
        "Ameiii muito, delicada como eu gosto é a manicure muito atenciosa🥰❤",
      estrelas: 5,
    },
    {
      nome: "Paola",
      bairro: "Petrópolis",
      depoimento:
        "Adorei minhas unhas e ainda recebi elogios! O atendimento foi ótimo, me deixou muito à vontade e o tempo voou. Sobre melhorias, não tenho nada a apontar. Quando você fez minhas unhas, ainda estava no começo, então tinha coisas pra evoluir. Mas, vendo suas fotos recentes, notei que você já melhorou muito nesses pontos. Por isso, hoje só tenho como te elogiar e recomendar!",
      estrelas: 4,
    },
    {
      nome: "Carla M.",
  ...
  const antesDepois = [
    {
      antes: antes1,
      depois: depois1,
      titulo: "Transformação com Postiças",
    },
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      resposta:
        "A esmaltação em gel é conhecida por sua alta durabilidade, podendo durar de 15 a 30 dias sem lascar, mantendo o brilho e a cor intactos.",
    },
    {
    ...
    },
    {
      ...
      resposta:
        "Aceito pagamentos via Pix e dinheiro. Tudo para facilitar para você!",
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50 dark:from-gray-900 dark:via-black dark:to-purple-950">
      ...
      <main className="container mx-auto px-4">
        <section id="portfolio" className="py-20">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-center mb-4 bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent leading-tight pb-1">
              Meus Trabalhos
            </h2>
        ...
        <section className="py-20">
          ...
          >
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent leading-tight pb-1">
                Indique uma Amiga
              </h2>
        ...
        <section className="py-20">
          <motion.div
            ...
            className="max-w-4xl mx-auto"
          >
            <h2 className="text-4xl md:text-5xl font-bold text-center mb-12 bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent leading-tight pb-1">
              Sobre Mim
            </h2>
